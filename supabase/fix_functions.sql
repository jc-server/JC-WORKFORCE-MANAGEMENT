-- Fix apply_attendance_with_payment function
...
BEGIN
    ...
    -- Update worker's current advance balance
    UPDATE workers 
    SET current_advance = COALESCE(current_advance, 0) + p_amount
    WHERE id = p_worker_id;
...
-- Fix get_today_summary function
